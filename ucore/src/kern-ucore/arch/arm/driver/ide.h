...
int ide_read_secs(unsigned short ideno, unsigned long secno, void *dst, unsigned long nsecs);
int ide_write_secs(unsigned short ideno, unsigned long secno, const void *src, unsigned long nsecs);
...
struct ide_device {
  ...
  /* return 0 if succeed */
  int (*read_secs)(struct ide_device *dev, unsigned long secno, void *dst, unsigned long nsecs);
  int (*write_secs)(struct ide_device *dev, unsigned long secno, const void *src, unsigned long nsecs);
